...
[`1.1.1-beta.1`](docs/releases/1.1.1-beta.1.md); use it on test or pilot
...
- [Release notes for 1.1.1 Beta 1](docs/releases/1.1.1-beta.1.md) and the [change log](docs/CHANGELOG.md)
