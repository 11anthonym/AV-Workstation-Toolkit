...
| Catalog reproducibility | Pass; 114 authoritative vendor files compile to the tracked 283-record runtime artifact, and release preflight rejects source/artifact drift before clearing prior output |

## Automated coverage

| Area | Result | Evidence |
|---|---|---|
| Catalog schema, policies, unique IDs, profiles, risks, and forbidden products | Pass | 30 managed WinGet, 25 operational external, and 283 awareness records aggregate to 338 unique records |
