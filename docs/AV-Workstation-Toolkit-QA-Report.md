...
|---|---|---|
| Catalog schema, policies, unique IDs, profiles, risks, and forbidden products | Pass | 29 managed WinGet, 25 operational external, and 283 awareness records aggregate to 337 unique records |
