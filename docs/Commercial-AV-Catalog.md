...
|---|---|---:|---|
| `manifests/managed-applications.json` | Compiled-runtime exact-ID, approved WinGet applications | 30 | Yes, subject to profile, risk, hold, reboot, and live-state checks |
...
The combined catalog has 338 unique records. Seven operational records are independently detectable Crestron child applications delivered through one shared secure parent provider.
