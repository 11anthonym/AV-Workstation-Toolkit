...
- Deterministic provider tests cover all 337 records, every normalized discipline, licensing/access/distribution composition, 283 commercial awareness holds, representative registry entries, direct-download lookalike/stale URLs, signed-cache tampering, and SFTP XML DTD/traversal/incomplete feeds.
