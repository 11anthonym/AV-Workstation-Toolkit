...
This pass also separated broad commercial AV knowledge from operational providers. The combined catalog now has 335 records, but only the original exact-ID WinGet allowlist can reach a change request. All 306 external records remain on manual holds; 281 of them are the commercial awareness layer. Schema 3 validates licensing, access, distribution policy, workflow, installation form, lifecycle, provenance, verification age/quarantine, impact, platform, official source, and parent relationships without interpreting catalog knowledge as deployment approval.
...
- 29-package exact-ID WinGet allowlist, 25 operational external records, and 281 awareness records, with cross-catalog duplicate detection and explicit VirtualBox exclusion;
